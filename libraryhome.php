 <?php
	...
	$messageClient = new MessageApi($apiClient);
	 	...
	 	if (isset($_POST['add'])) {
	 		header("location: libraryblist.php");
	 	}
?>
<?php 
	session_start();
...
<body>
	...
	<nav class="navbar navbar-inverse navbar-static-top">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo site_url('libraryhome.php?sid='.session_id()); ?>" style="color: white">&nbsp; SPCF Online TOR Request System</a>
		</div>
	...
	<?php 
     ...
     <?php 
     	if (isset($_GET['blist'])) {
			echo "<center>
				  <table>
				  	<caption style='margin-top: 20px'> Library Blacklist </caption>	
					...
					<tr>
						<td>
							<form method='post' style = 'text-align: left; '>
								...
								<button type='submit' name='add' style='margin-left: 5px; background-color: #4A8AF4; border: none; border-radius: 3px 3px 3px 3px'><span class='glyphicon glyphicon-plus'></span></button>
		...
		<center>
			<table>
				<tr>
							...
							<div class='input-group'>
								<td style='text-align: center; border: solid 1px #158A43'>
									<a href="libraryhome.php?trash=<?php echo "$rows2[student_ID]" ?>">
	 ...
	 <?php 
	 	if (isset($_GET['trash'])) {
	 		$stud2 = $_GET['trash'];
	 			...
	 			header("location: libraryhome.php?blist");
	 }
	  ?> 
		...
		<center>
			<table style="width: 90%">
				<tr>
							...
							<div class='input-group'>
								<td style='text-align: center; border: solid 1px #158A43'>
									<label style='font-size: 10pt; '><?php echo ucwords($educational_level); ?></label>
								</td>
							</div>
							<div class='input-group'>
								<td style='text-align: center; border: solid 1px #158A43'>
							...
							<div class='input-group'>
								<td style='text-align: center; border: solid 1px #158A43'>								
									<a href="libraryhome.php?ok=<?php echo "$rows6[student_ID]" ?>">
							...
							<div class='input-group'>
								<td style='text-align: center; border: solid 1px #158A43'>								
									<a href="libraryhome.php?del=<?php echo "$rows6[student_ID]" ?>">
							...
							<div class='input-group'>
								<td style='text-align: center; border: solid 1px #158A43'>								
									<a href="libraryhome.php?erase=<?php echo "$rows6[student_ID]" ?>">
	...
	<?php 
	 	if (isset($_GET['del'])) {
	 		...
	 		if (mysqli_num_rows($rows10) > 0) {
	 			header("location: libraryhome.php?reqs");
	 		}else{	
