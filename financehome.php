 <?php
	...
	if (isset($_POST['add'])) {
		header("location: financeblist.php");
	}
 ...
 <body>
 	<div class="container-fluid">
 		<nav class="navbar navbar-inverse navbar-static-top">
 			<div class="navbar-header">
 				...
 				<a class="navbar-brand" href="<?php echo site_url('financehome.php?sid='.session_id()); ?>" style="color: white">&nbsp; SPCF Online TOR Request System</a>
 			</div>
 	...
 	<?php
		if (isset($_GET['blist'])) {
			echo "<center>
				  <table>
				  	<caption style='margin-top: 20px'> Finance Blacklist </caption>	
 					...
 					<center>
 						<table>
 							<tr>
 								...
 								<div class='input-group'>
 									<td style='text-align: center; border: solid 1px #158A43'>
 										<a href="financehome.php?trash=<?php echo "$rows2[student_ID]" ?>">
 	...
 	<?php
		if (isset($_GET['trash'])) {
			...
			header("location: financehome.php?blist");
		}
		?>
 				...
 				<table style='width: 90%'>
 					<tr>
						...
						<div class='input-group'>
 						...
 						<div class='input-group'>
 							<td style='text-align: center; border: solid 1px #158A43'>
 								<a href="financehome.php?ok=<?php echo "$rows6[student_ID]" ?>">
 						...
 						<div class='input-group'>
 							<td style='text-align: center; border: solid 1px #158A43'>
 								<a href="financehome.php?del=<?php echo "$rows6[student_ID]" ?>">
 						...
 						<div class='input-group'>
 							<td style='text-align: center; border: solid 1px #158A43'>
 								<a href="financehome.php?erase=<?php echo "$rows6[student_ID]" ?>">
		...
		if (isset($_GET['del'])) {
			...
			while ($rows7 = mysqli_fetch_array($row7)) {
				...
				if (mysqli_num_rows($rows10) > 0) {
					header("location: financehome.php?reqs");
				} else {
 	...
 	<?php
		if (isset($_GET['ok'])) {
			...
			while ($rows7 = mysqli_fetch_array($row7)) {
				...
				if (mysqli_num_rows($rows10) > 0) {
					header("location: guidancehome.php?reqs");
				} else {
