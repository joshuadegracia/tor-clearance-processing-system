 <?php
	...
	if (isset($_POST['add'])) {
		header("location: guidanceblist.php");
	}
 ...
 <body>
 	<div class="container-fluid">
 		<nav class="navbar navbar-inverse navbar-static-top">
 			<div class="navbar-header">
 				...
 				<a class="navbar-brand" href="<?php echo site_url('guidancehome.php?sid=' . session_id()); ?>" style="color: white">&nbsp; SPCF Online TOR Request System</a>
 			</div>
 	...
 	<?php
		if (isset($_GET['blist'])) {
			echo "<center>
				  <table>
				  	<caption style='margin-top: 20px'>SPS/Guidance</caption>	
 					...
 					<center>
 						<table>
 							<tr>
 								...
 								<div class='input-group'>
 									<td style='text-align: center; border: solid 1px #158A43'>
 										<a href="guidancehome.php?trash=<?php echo "$rows2[student_ID]" ?>">
 	...
 	<?php
		if (isset($_GET['trash'])) {
			...
			header("location: guidancehome.php?blist");
		}
		?>
 				...
 				<table style="width: 90%">
 					<tr>
						...
						<div class='input-group'>
 						...
 						<div class='input-group'>
 							<td style='text-align: center; border: solid 1px #158A43'>
 								<a href="guidancehome.php?ok=<?php echo "$rows6[student_ID]" ?>">
 						...
 						<div class='input-group'>
 							<td style='text-align: center; border: solid 1px #158A43'>
 								<a href="guidancehome.php?del=<?php echo "$rows6[student_ID]" ?>">
 						...
 						<div class='input-group'>
 							<td style='text-align: center; border: solid 1px #158A43'>
 								<a href="guidancehome.php?erase=<?php echo "$rows6[student_ID]" ?>">
