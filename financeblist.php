...
$row = mysqli_query($con, "SELECT * FROM admin WHERE admin_ID='$user'");
	...
	<div class="container-fluid">
		<nav class="navbar navbar-inverse navbar-static-top">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo $_SERVER['PHP_SELF']; ?>" style="color: white">&nbsp; SPCF Online TOR Request System</a>
			</div>
	...
	<div>
		<form method="post" class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<input type="text" name="remark" id="remark" class="form-control input-sm" required>
			</div>
			...
			<div class="form-group text-center">
				<?php if (isset($_GET['addfailed'])): ?>
					<div class="alert alert-danger" style="display: inline-block;">
						This student already has a record!
					</div>
		...
		if (isset($_POST['addbtn'])) {
			...
			if (mysqli_num_rows($result1) > 0) {
				header("location: financeblist.php?addfailed");
			} else {
			...
			if (mysqli_num_rows($result) == 0) {
				header("location: financeblist.php?invalid");
			}
		}
		?>
